<?php /* Smarty version 2.6.26, created on 2013-03-16 02:26:32
         compiled from C:%5Cxampp%5Chtdocs%5Cmdlsist/Mdl-Sist%5C%5Csite%5C%5CApplication%5Cviews%5CAlbuns/albuns.tpl */ ?>
...
" style="  float:left; margin: 5px; text-align:center; width:140px; height:100px; list-style:none; text-align: center;vertical-align: middle">
        ...
        <a href="#none"   event="click" id="arquivos" name="../Arquivo/arquivos" params="album=<?php echo $this->_tpl_vars['albuns'][$this->_sections['i']['index']]['id']; ?>
">
        <?php else: ?>

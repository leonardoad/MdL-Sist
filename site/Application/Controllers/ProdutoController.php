...
//		$grid->setOrder('Nome');
        ...
        $grid->addColumn($column);
//
//        $column = new Ui_Element_Grid_Column_Text('Descricao', 'descricao', '150');
//        $grid->addColumn($column);

        $column = new Ui_Element_Grid_Column_Text('Categoria', 'desctipoproduto', '200');
        $grid->addColumn($column);
    ...
    public function edit() {
        ...
        $element = new Ui_Element_Select('id_tipoproduto');
        $element->addMultiOptions(Tipoproduto::getOptionList('id_tipoproduto', 'descricao', $tipo, false));
        $element->setAttrib('obrig', 'obrig');
        $element->setRequired();
        $tab->addElement($element);
